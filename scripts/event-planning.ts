 ...
 * @param e Click event
 */
const handleViewEvent = (e: Event): void => {
 ...
 */
const getPlannedEvents = (): PlannedEvent[] => {
 ...
 */
const getEventById = (id: string): PlannedEvent | null => {
 ...
 */
const saveEvent = (event: PlannedEvent): void => {
    const events = getPlannedEvents();
    events.push(event);
