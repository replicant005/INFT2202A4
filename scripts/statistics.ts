 ...
 */
const fetchStatisticsData = async (): Promise<VisitorStatistic[]> => {
    try {
 ...
 */
export const renderStatisticsPage = async (): Promise<string> => {
    return `
            ...
            <div class="col-md-6 mb-4">
                <div class="card shadow">
                    <div class="card-header bg-success text-white">
                        <h2 class="h4 mb-0">New vs Returning Users</h2>
                    </div>
                    <div class="card-body">
 ...
 */
export const initStatisticsPage = async (): Promise<void> => {
    try {
 ...
 */
const populateStatisticsTable = (statistics: VisitorStatistic[]): void => {
 ...
 * @param statistics Array of visitor statistics
 */
const createVisitorChart = (statistics: VisitorStatistic[]): void => {
    const chartCanvas = document.getElementById('visitorChart') as HTMLCanvasElement;
    if (!chartCanvas) {
 ...
 * @param statistics Array of visitor statistics
 */
const createUserTypeChart = (statistics: VisitorStatistic[]): void => {
    const chartCanvas = document.getElementById('userTypeChart') as HTMLCanvasElement;
    if (!chartCanvas) {
 ...
 * @param statistics Array of visitor statistics
 */
const createSessionDurationChart = (statistics: VisitorStatistic[]): void => {
    const chartCanvas = document.getElementById('sessionDurationChart') as HTMLCanvasElement;
    if (!chartCanvas) {
