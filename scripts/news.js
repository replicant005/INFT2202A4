 ...
 */
export const renderNewsPage = async () => {
    try {
            ...
            articleElement.innerHTML = `
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        ${((_a = article.source) === null || _a === void 0 ? void 0 : _a.name) ? `<small class="text-muted">Source: ${article.source.name}</small>` : ''}
                    </div>
                </div>
            `;
