...
function updateHeaderAuthState() {
    ...
    if (isLoggedIn) {
        ...
        const loginElement = (_a = document.querySelector('#login')) === null || _a === void 0 ? void 0 : _a.closest('li');
        ...
        if (userDropdownContainer) {
            ...
            if (userDisplayName) {
                userDisplayName.textContent = `Welcome, ${(currentUser === null || currentUser === void 0 ? void 0 : currentUser.displayName) || 'User'}`;
            }
        }
    }
    else {
        // Show login link, hide user dropdown
        const loginElement = (_b = document.querySelector('#login')) === null || _b === void 0 ? void 0 : _b.closest('li');
        const userDropdownContainer = document.querySelector('#userDropdownContainer');
        if (loginElement) {
