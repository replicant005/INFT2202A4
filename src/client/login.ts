 ...
 */
export const renderLoginPage = async (): Promise<string> => {
    try {
 ...
 */
export const initLoginPage = (): void => {
 ...
 */
const displayErrorMessage = (messageArea: HTMLElement, message: string): void => {
 ...
 * @param message Message to display
 */
const displaySuccessMessage = (messageArea: HTMLElement, message: string): void => {
    messageArea.textContent = message;
