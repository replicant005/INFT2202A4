...
import { renderHeader, initHeader, LoadHeader } from './header.js';
...
import ContactView from './feedback';
...
document.addEventListener('DOMContentLoaded', async() => {
    ...
    document.addEventListener('pageLoaded', (e: Event) => {
...
function setupAuthListeners(): void {
    ...
    document.addEventListener('userLogin', async (e: Event) => {
        console.log('[INFO] User logged in:', (e as CustomEvent).detail.user);
